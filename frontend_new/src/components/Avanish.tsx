          ...
          <div className="flex items-center justify-center mb-8">
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center">
                <div
                  className={`w-8 h-8 rounded-lg flex items-center justify-center ${currentStep >= step.id ? "bg-orange-500 text-white" : "bg-gray-100 text-gray-400"}`}
                >
                  <step.icon className="w-4 h-4" />
                </div>
                {index < steps.length - 1 && (
                  <div
                    className={`h-1 w-8 mx-2 ${currentStep > step.id ? "bg-orange-500" : "bg-gray-100"}`}
                  />
                )}
              </div>
            ))}
